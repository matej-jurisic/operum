...
namespace Operum.Model.Common
{
    public class ServiceResponse
    {
        ...
        public static ServiceResponse Success() => new() { StatusCode = StatusCodeEnum.Ok, Messages = [StatusCodeEnum.Ok.ToString()] };
        ...
        public static ServiceResponse<T> Success<T>(T data) => new() { Data = data, StatusCode = StatusCodeEnum.Ok, Messages = [StatusCodeEnum.Ok.ToString()] };
    }

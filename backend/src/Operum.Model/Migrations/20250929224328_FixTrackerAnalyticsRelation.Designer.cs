...
namespace Operum.Model.Migrations
{
    ...
    [Migration("20250929224328_FixTrackerAnalyticsRelation")]
    partial class FixTrackerAnalyticsRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Operum.Model.Models.Analytic", b =>
                {
                    ...
                    b.HasIndex("AnalyticTypeId");

                    b.ToTable("Analytics");
                });

            modelBuilder.Entity("Operum.Model.Models.AnalyticRequiredDataType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("AnalyticRequiredDataTypes");
                });

            modelBuilder.Entity("Operum.Model.Models.AnalyticType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Operum.Model.Models.TrackerAnalyticField", b =>
                {
                    ...
                    b.Property<string>("TrackerAnalyticId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TrackerAnalyticId");

                    b.ToTable("TrackerAnalyticDataTypesField");
                });
            ...
            modelBuilder.Entity("Operum.Model.Models.Analytic", b =>
                {
                    b.HasOne("Operum.Model.Models.AnalyticType", "AnalyticType")
                        .WithMany()
                        .HasForeignKey("AnalyticTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnalyticType");
                });

            modelBuilder.Entity("Operum.Model.Models.AnalyticRequiredDataType", b =>
                {
                    b.HasOne("Operum.Model.Models.Analytic", "Analytic")
                        .WithMany("AnalyticRequiredDataTypes")
            ...
            modelBuilder.Entity("Operum.Model.Models.Analytic", b =>
                {
                    b.Navigation("AnalyticRequiredDataTypes");
                });
